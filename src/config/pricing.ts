...
export const PRODUCTS: Product[] = [
  {
    ...
    category: "tshirt",
    description:
      "Ideal para el día a día, marcas, eventos y uniformes.",
    ...
    colors: [
      ...
      { key: "turquesa", label: "Turquesa", hex: "#1abc9c", image: "/img/tee/turquesa.webp" },

      // 🔹 Amarillos / Cálidos
      { key: "amarillo", label: "Amarillo", hex: "#f4d03f", image: "/img/tee/amarillo.webp" },
      { key: "limon", label: "Limón", hex: "#cddc39", image: "/img/tee/limon.webp" },
  ...
  // ✅ NUEVO: Playera 50/50 (algodón/poliéster)
  {
    id: "tshirt-5050",
    name: "Playera 50/50",
    category: "tshirt",
    description:
      "Mezcla 50% algodón / 50% poliéster. Excelente para impresión DTF.",

    colors: [
      // 🔹 Neutros / Grises (primero)
...

  {
    ...
    category: "sweatshirt",
    description: "Sudadera cuello redondo de acabado afelpado por dentro.",
